...
const Skills = ({ skillData }: Props) => {
  ...
  return (
    <SectionWrapper
      id="skills"
      className="min-h-screen mt-12 md:mt-0 mx-4 md:mx-0 xl:my-20 2xl:my-0 bg-gradient-to-b from-white to-gray-100/20 dark:from-slate-800 dark:to-slate-900"
    >
          ...
          <span
            ...
            className={`p-1.5 md:p-2 text-sm md:text-base w-full text-center cursor-pointer rounded-md ${
              category.toLowerCase() === c.toLowerCase()
                ...
                : "bg-white dark:bg-grey-800 hover:bg-gray-100 hover:dark:bg-slate-800"
