...
const Experiences = ({ experienceData, educationData }: Props) => {
  ...
  return (
    <SectionWrapper
      id="experience"
      className="min-h-screen bg-gradient-to-b from-gray-100/20 to-white dark:from-slate-900 dark:to-slate-800"
    >
      <h2 className="text-4xl text-center">Experience | 经验</h2>
          ...
          <button
            ...
            className={`py-2 px-4 rounded-md transition-colors ${
              show === e
                ...
                : "hover:bg-gray-100 hover:dark:bg-slate-800 text-black dark:text-white"
            }`}
          >
            {e}
          </button>
      ...
      <div className="lg:container sm:mx-4 lg:mx-auto lg:w-5/6 2xl:w-3/4">
        <div className="relative wrap overflow-hidden p-4 md:py-10 md:px-0">
          <div className="left-6 md:left-1/2 absolute border-opacity-20 border-cyan-400 dark:border-cyan-800 h-full border"></div>
