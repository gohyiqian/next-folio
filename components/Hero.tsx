        ...
        <div className="flex flex-col gap-4 md:gap-6 text-left lg:w-1/2 2xl:w-1/3 mx-4 md:mx-6 xl:mx-0">
          <div className="flex items-center gap-1">
            <Image
              ...
              src={wavingHand}
            />
            <p className="text-lg md:text-xl mt-2 md:mt-1.5">Hey 嘿!</p>
          </div>
          ...
          <div className="flex flex-row items-start md:items-center gap-1.5">
            ...
            <Typewriter
              options={{
                ...
                delay: 50,
                wrapperClassName:
                  "text-cyan-700 dark:text-cyan-600 text-lg md:text-2xl font-medium",
                cursorClassName:
                  "text-cyan-700 dark:text-cyan-600 text-lg md:text-2xl",
              }}
            />
          </div>
          ...
          <ScrollLink
            className="w-fit text-sm md:text-base py-2 px-4 cursor-pointer flex items-center gap-1 rounded-md bg-cyan-600 hover:bg-cyan-600 dark:bg-cyan-600 hover:dark:bg-cyan-800 transition-colors group text-white"
            to={"about"}
            offset={-60}
            smooth={true}
            duration={500}
