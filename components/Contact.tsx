...
const Contact = () => {
  ...
  return (
    <SectionWrapper
      id="contact"
      className="bg-gradient-to-b from-gray-100/20 to-white dark:from-slate-900 dark:to-slate-900"
    >
      <h2 className="text-center text-4xl">Contact Me | 和我联系</h2>
      <ToastContainer />
      ...
      <div className="w-full lg:w-5/6 2xl:w-3/4 mt-10 md:mt-16 mx-auto flex justify-between rounded-xl">
        ...
        <div className="flex-1">
          ...
          >
            ...
            <button
              disabled={loading}
              className="px-4 py-2 bg-cyan-600 hover:bg-cyan-600 transition-colors text-white rounded-lg disabled:cursor-not-allowed self-end"
            >
              {loading ? (
