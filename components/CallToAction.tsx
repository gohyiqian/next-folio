...
const CallToAction = () => {
  ...
  return (
    <SectionWrapper
      id="cta"
      className="xl:max-w-6xl my-24 lg:mx-10 xl:mx-auto mx-4 relative overflow-hidden flex flex-col-reverse md:flex-row gap-3 md:gap-0 items-center bg-gradient-to-r from-cyan-700 to-cyan-700 text-white rounded-2xl p-6 md:p-8 lg:px-12 lg:py-16 z-10"
    >
      <div className="flex flex-col md:w-1/2 lg:w-3/5">
        ...
        <div className="flex items-center gap-4 my-4">
          ...
          <Link
            ...
            target="_blank"
            className="py-2 px-4 bg-cyan-800 rounded-lg w-fit flex items-center gap-2 hover:bg-cyan-900 transition-all"
          >
            Visit Docs
            <BiLinkExternal />
          </Link>
