...
const Projects = ({ projectsData }: Props) => {
  ...
  return (
    <SectionWrapper
      id="projects"
      className="mx-4 md:mx-0 min-h-screen bg-gradient-to-b from-white to-gray-100/20 dark:from-slate-800 dark:to-slate-900"
    >
      <h2 className="text-4xl text-center">Projects | 项目</h2>
      ...
      <div className="overflow-x-auto scroll-hide md:w-full max-w-screen-sm mx-auto mt-6 flex justify-between items-center gap-2 md:gap-3 bg-white dark:bg-grey-800 p-2 rounded-md">
        {categories.reverse().map((c: string = "", i: number) => (
          <span
            key={i}
...
export const ViewAll = ({
  ...
  return (
    <>
      <div className="bg-white dark:bg-slate-800 w-4/5 mx-auto blur-xl z-20 -translate-y-14 h-16"></div>
